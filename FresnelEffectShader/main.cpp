...
//#define RESOURCE_PATH "C:\\Users\\bariscanakin\\Downloads\\Ders 7\\Ders 7\\"
#ifdef _WIN32
#include <windows.h>
#include <GL/glew.h>
#include <GL/GL.h>
...
#define WINDOW_TITLE_PREFIX "Fresnel Effect"
...
static void Draw(void)
{
	...
	scene->draw(fReflectance, fPower);
...
static void timerCallback (int value)
{
    if (0 != value) {
		...
		sprintf(
                TempString,
                "%s: %d Frames Per Second @ %d x %d, Fresnel Reflectance: %.2f, Fresnel Power: %.2f",
                WINDOW_TITLE_PREFIX,
                FrameCount * 4,
                CurrentWidth,
                CurrentHeight,
